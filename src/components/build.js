...
function Build() {
  return (
    <section id="build" className="build">
      ...
      <h2>My Build</h2>
          <p> I build an AI application that takes in a user's youtube video, or a video file, reads the transcript, and then gives them saved notes based on detail level. The notes can be exported as .docx or .pdf and edited on the site. This was originally made as a study tool, but I quickly realized it would be better used as a resource for all speech, video, or media of any sort to allow people to get get convenient summaries in any situation<br /><br /> <b>In fact, the summary shown in the features was generated by this product. </b> <br /><br />Technologies Used: Streamlit, Python3, LLaMa3, MongoDB, YoutubeTranscriptReader, AssemblyAI.<br /><br /> The GitHub repository as well as installation instructions to test this yourself are linked:<br></br>
